...
<c:if test="${not empty session.user }">
	...
	<div style="margin: 80px;">
		<h1 class="label label-info">房间退订</h1>
		<br>
		<br>
		<div >
			<table class="table table-hover table-striped table-bordered table-condensed">
				<thead><tr class="success"><th>ID</th><th>房间名</th><th>价格</th><th>分类</th><th>退订</th></tr></thead>
				<c:forEach items="${rooms }" var="c">
					<tr>
						...
						<td>${c.price }</td>
						<td>${c.category }</td>
						<td><a href="${pageContext.request.contextPath }/user_delete_order?room.roomid=${c.roomid}&order.room.roomid"><span class="glyphicon glyphicon-minus"></span></a></td>
					</tr>
				</c:forEach>
			</table>
